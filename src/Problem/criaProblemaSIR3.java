...
public class criaProblemaSIR3 {
    ...
    public criaProblemaSIR3(int s, int i, int r, double beta, double lambda, double costvaccine, double costinf, Problem p,double exp) {
        ...
        geraTodasAcoes2ComProbe2Binomiais2custoexp(10,exp);
    }
