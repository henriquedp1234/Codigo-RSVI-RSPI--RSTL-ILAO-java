 ...
 */
public class criaProblemaIgorpositivo {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorpositivo(int Nx, int Ny, Double p, Problem prob) {
       // double p1 = p;
