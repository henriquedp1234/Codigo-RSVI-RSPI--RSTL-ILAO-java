 ...
 */
public class criaProblemaIgorVersãoVoltaInicio3 {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorVersãoVoltaInicio3(int Nx, int Ny, double p, Problem prob, double costriver, double cost, double probMoveOutsideRiver) {
        // double p1 = p;
