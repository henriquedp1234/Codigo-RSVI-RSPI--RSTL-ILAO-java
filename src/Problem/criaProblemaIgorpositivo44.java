 ...
 */
public class criaProblemaIgorpositivo44 {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorpositivo44(int Nx, int Ny, Double p, Problem prob) {
        // double p1 = p;
...
if (h.contains("move-E")==false)
{
    ...
    if (h.contains("move-W")==false){
        ...
        //  }
        //r.setGoalState(m[0][Ny - 1]);
        m[0][Ny - 1].apagaMeta();


      /*  m[0][Ny - 1].getActions().clear();//meta
        ação a = new ação();
        ação a2 = new ação();
        ação a3 = new ação();
        ação a4 = new ação();
        ...
        a.setCurrentState(  m[0][Ny - 1]);
        a2.setCurrentState((  m[0][Ny - 1]));
        a3.setSuccessorState((  m[0][Ny - 1]));
        a4.setSuccessorState((  m[0][Ny - 1]));
        a.setSuccessorState((  m[0][Ny - 1]));
        a2.setSuccessorState((  m[0][Ny - 1]));
        a3.setSuccessorState((  m[0][Ny - 1]));
        a4.setSuccessorState((  m[0][Ny - 1]));
        a.setActionName("move-N");
        a2.setActionName("move-S");
        ...
        m[0][Ny - 1].addAction(a);
        m[0][Ny - 1].addAction(a2);
        m[0][Ny - 1].addAction(a3);
        m[0][Ny - 1].addAction(a4);


        m[0][Ny - 1].setUtilityValue(1.0);//meta
        r.setInitialState(m[0][0]);//estado inicial
*/

        Acao a = new Acao("move-N");
        a.adicionaTransicao(m[0][Ny-1],0,1);
        Acao a2 = new Acao("move-S");
        a2.adicionaTransicao(m[0][Ny-1],0,1);
        Acao a3 = new Acao("move-E");
        a3.adicionaTransicao(m[0][Ny-1],0,1);
        Acao a4 = new Acao("move-W");
        a4.adicionaTransicao(m[0][Ny-1],0,1);
