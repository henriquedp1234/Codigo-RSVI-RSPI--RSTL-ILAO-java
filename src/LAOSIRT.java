...
public class LAOSIRT {
  ...
  /*  public LAOSIRT(Problem p, double qnormal, double qmeta) {
        count = 0;
        this.p = p;
...
*/
    ...
    public LAOSIRT(Problem p, double qnormal, double qmeta)//sem heuristica
    ...
    public LAOSIRT(Problem p, double qnormal, double qmeta, int k)//2Lao
  ...
  */
    public LAOSIRT(Problem p, double qnormal, double qmeta, int x, int y)//heuristica determinizacao
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
        ...
        Cronometro cT = new Cronometro();
        cT.start();
        valueIterationHeuristic(0.0000000000001, x, y);
        // p.setK(1.0);
        cT.stop();
        averageTime += cT.getTempo();

        h = new NewHeuristica3(p.getFinalStates(), heur, Q2);
    ...
    public LAOSIRT(Problem p, double qnormal, double qmeta, int x, int y, int pranada)//heuristica iv
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
...
*/
    ...
    public void printSIR(Arquivo file,int tamanhoMAxS,int n,Arquivo file2 ) {
...
*/
            ...
            for (int i = 0; i < tamanhoMAxS; i++) {
                    ...
                    for (int i2 = 0; i2 < tamanhoMAxS; i2++) {
                        if (a[i][i2] == null) {
                            System.out.print("*");
                            file.escreveArquivo2("*"); file2.escreveArquivo2("* ");
                        }

                        else {
                            if (a[i][i2].equals("acao1")) {
                                System.out.print("0");
                                file.escreveArquivo2("0"); file2.escreveArquivo2("0 ");
                            }
                            else if (a[i][i2].equals("acao2")) {
                                System.out.print("1");
                                file.escreveArquivo2("1"); file2.escreveArquivo2("1 ");
                            }
                            else if (a[i][i2].equals("acao3")) {
                                System.out.print("2");
                                file.escreveArquivo2("2");file2.escreveArquivo2("2 " );
                            }
                            else if (a[i][i2].equals("acao4")) {
                                System.out.print("3");
                                file.escreveArquivo2("3");file2.escreveArquivo2("3 ");
                            }
                            else if (a[i][i2].equals("acao5")) {
                                System.out.print("4");
                                file.escreveArquivo2("4");  file2.escreveArquivo2("4 ");
                            }
                            else if (a[i][i2].equals("acao6")) {
                                System.out.print("5");file.escreveArquivo2("5");file2.escreveArquivo2("5 ");
                            }
                            else if (a[i][i2].equals("acao7")) {
                                    System.out.print("6");
                                file.escreveArquivo2("6");file2.escreveArquivo2("6 ");
                            }
                            else if (a[i][i2].equals("acao8")) {
                                System.out.print("7");file.escreveArquivo2("7");file2.escreveArquivo2("7 ");
                            }
                            else if (a[i][i2].equals("acao9")) {
                                System.out.print("8");file.escreveArquivo2("8");file2.escreveArquivo2("8 ");
                            }
                            else if (a[i][i2].equals("acao10")) {
                                System.out.print("9");file.escreveArquivo2("9");file2.escreveArquivo2("9 ");
                            }
                            else if (a[i][i2].equals("acao11")) {
                                System.out.print("!");file.escreveArquivo2("!");file2.escreveArquivo2("! ");
                            }
                            else if (a[i][i2].equals("meta")) {
                                System.out.print("k");file.escreveArquivo2("k");file2.escreveArquivo2("k ");
                            }else
                            {
                                System.out.print("-");file.escreveArquivo2("-");file2.escreveArquivo2("- ");
                            }
    ...
    public void printSIR2(Arquivo2 file,int tamanhoMAxS,int n,Arquivo2 file2 ) {
