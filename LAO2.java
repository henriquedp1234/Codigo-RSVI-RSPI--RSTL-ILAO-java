...
public class LAO2 {
    ...
    public LAO2(Problem p, double qnormal, double qmeta)//sem heuristica
    ...
    public LAO2(Problem p, double qnormal, double qmeta, int k)//2Lao
  ...
  /*  public LAO2(Problem p, double qnormal, double qmeta, int x, int y)//heuristica determinizacao
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
...
*/
  public LAO2(Problem p, double qnormal, double qmeta, int x, int y)//heuristica determinizacao
  {
    ...
    public LAO2(Problem p, double qnormal, double qmeta, int x, int y, int pranada)//heuristica iv
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
...
*/
    ...
    public void print22(Arquivo file, int a1, int b1) {
        Set<Integer> chaves = setZ.keySet();
        String[][] a = new String[b1][a1];
...
*/
                ...
                if (e.getAction(0).getQ()==e.getAction(1).getQ()&&e.getAction(0).getQ()==e.getAction(2).getQ()&&e.getAction(0).getQ()==e.getAction(3).getQ()) {
                    a[x - 1][y - 1] = "+";
                }else{
                    a[x - 1][y - 1] = e.getAction(e.getBestAction()).getName();}
                // file.escreveArquivo("Estado: " + e.getName() + " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getCost());
...
*/
    ...
    public void callvalueIteration() {
    ...
    public boolean valueIteration(HashMap<Estado, HashMap<Acao, Double>> Qlinha1) {
...
*/
   ...
   /*     String nome = " X= " + x + " Y=" + y + " k= " + p.getK() + " desconto= " + p.getDiscount() + " passo= " + p.getTamanhoPasso() + " 2.txt";
            ...
            for (int y = 0; y < z; y++) {
                ...
                if ((t.get(s.getAction(0)).equals(t.get(s.getAction(1)))) && (t.get(s.getAction(0)).equals(t.get(s.getAction(2)))) && (t.get(s.getAction(0)).equals(t.get(s.getAction(3))))) {
                    if (t.get(s.getAction(0)).equals(0.0)) {
                        System.out.print("O");
                        arquivoSaida.escreveArquivo2("O");
                    } else {
                        System.out.print("+");
    ...
    public void imprimedireçãoQ4(int x, int z, String nomeArquivo, String diret,HashMap<Estado,Acao> politica) {
        Arquivo2 arquivoSaida = new Arquivo2(nomeArquivo, Arquivo2.ESCRITA, diret);
        arquivoSaida.escreveArquivo("k= " + p.getK() + " desconto= " + p.getDiscount() + " passo= " + p.getTamanhoPasso());
        String[][] a = new String[x][z];
        int y1 = x;
        ...
        for (int i = x - 1; i >= 0; i--) {
            ...
            for (int y = 0; y < z; y++) {
                ...
                if ((t.get(s.getAction(0)).equals(t.get(s.getAction(1)))) && (t.get(s.getAction(0)).equals(t.get(s.getAction(2)))) && (t.get(s.getAction(0)).equals(t.get(s.getAction(3))))) {
                    ...
                    System.out.print("→");
                    s.getActionPorNome("move-E");
                    politica.put(s,s.getActionPorNome("move-E"));
                    arquivoSaida.escreveArquivo2("→");
                } else if (nome.equals("move-W")) {
                    System.out.print("←");
                    politica.put(s,s.getActionPorNome("move-W"));
                    arquivoSaida.escreveArquivo2("←");
                } else if (nome.equals("move-N")) {
                    System.out.print("↑");
                    politica.put(s,s.getActionPorNome("move-N"));
                   arquivoSaida.escreveArquivo2("↑");
                } else if (nome.equals("move-S")) {
                    System.out.print("↓");
                    politica.put(s,s.getActionPorNome("move-S"));
                    arquivoSaida.escreveArquivo2("↓");
                }
    ...
    public void imprimedireçãoQ5(int x, int z, String nomeArquivo, String diret,HashMap<Estado,Acao> politica) {
        Arquivo2 arquivoSaida = new Arquivo2(nomeArquivo, Arquivo2.ESCRITA, diret);
        arquivoSaida.escreveArquivo("k= " + p.getK() + " desconto= " + p.getDiscount() + " passo= " + p.getTamanhoPasso());
        String[][] a = new String[x][z];
        int y1 = x;
        ...
        for (int i = x - 1; i >= 0; i--) {
            ...
            for (int y = 0; y < z; y++) {
              ...
              //  HashMap<Acao, Double> t = Q2.get(s);
                ...
                if (politica.get(s).getName().equals("move-E")) {
                    System.out.print("→");
                    s.getActionPorNome("move-E");
                 //   politica.put(s,s.getActionPorNome("move-E"));
                    arquivoSaida.escreveArquivo2("→");
                } else if (politica.get(s).getName().equals("move-W")) {
                    System.out.print("←");
                   // politica.put(s,s.getActionPorNome("move-W"));
                    arquivoSaida.escreveArquivo2("←");
                } else if (politica.get(s).getName().equals("move-N")) {
                    System.out.print("↑");
                    //politica.put(s,s.getActionPorNome("move-N"));
                    arquivoSaida.escreveArquivo2("↑");
                } else if (politica.get(s).getName().equals("move-S")) {
                    System.out.print("↓");
                    //politica.put(s,s.getActionPorNome("move-S"));
                    arquivoSaida.escreveArquivo2("↓");
                }
...
*/
 ...
 /*       System.out.println ();
    ...
    public void policyIteration(HashMap<Estado,Acao> politica, int z, int x) {
        for (Estado s : p.getEstados().values()) {//inicializar V
        ...
        do {//0.0000001
            policyEvaluation(0.00000000000001, 1, 1, politica);
            compara = policyImrprovement(politica);
        } while (compara == false);
    }
    public void policyEvaluationBelman(Double minError, int x, int y, HashMap<Estado,Acao> politica)//Política
    {
        Map<Integer, Estado> estados = this.p.getEstados();
        ...
        do {
            ...
            for (Iterator<Integer> it2 = estados.keySet().iterator(); it2.hasNext(); ) {//percorre todos os estados
                ...
                for (Iterator<Transicao> it = politica.get(estadoCorrente).getTransitions().iterator(); it.hasNext(); ) //itera por todas transições da politica a
                {
                    ...
                    double Vtransicao = Vlinha.get(trans.getState());
                    //double Vanterior = Vlinha.get(estadoCorrente);//qanterior
                    //ouble X = calculaX(politica.get(estadoCorrente).getCost(), p.getDiscount(), Vtransicao, Vanterior, p.getK());
                   // somatudo += prob * X;
                    somatudo=somatudo+prob*(politica.get(estadoCorrente).getCost()+p.getDiscount()*Vtransicao);
                }
               // somatudo = somatudo * p.getTamanhoPasso();
                //double calculaQsa = V.get(estadoCorrente) + somatudo;
                double calculaQsa = somatudo;
                //qtdeValueIteration2++;
                V.put(estadoCorrente, calculaQsa);
                residualEstados = ((V.get(estadoCorrente)) - erroVanterior) / erroVanterior;
                residualEstados = Math.abs(residualEstados);
    ...
    public boolean  policyImrprovementBelman(HashMap<Estado,Acao> politica) {
        boolean naomudouPolitica = true;
        Map<Integer, Estado> estados = this.p.getEstados();
        // Q2 = new HashMap<>();
        //V = new HashMap<>();
        ...
        for (Iterator<Integer> it2 = estados.keySet().iterator(); it2.hasNext(); ) {//percorre todos os estados
            ...
            for (int i = 0; i < size; i++) {//itera por todas as acoes do estado s
                ...
                for (Iterator<Transicao> it = t.iterator(); it.hasNext(); ) //itera por todas transições da açao a
                {
                    ...
                    //double Vanterior = Vlinha.get(estadoCorrente);//qanterior
                   // double X = calculaX(a.getCost(), p.getDiscount(), Vtransicao, Vanterior, p.getK());
                    somatudo=somatudo+prob*(a.getCost()+p.getDiscount()*Vtransicao);
                }
               // somatudo = somatudo * p.getTamanhoPasso();
                double calculaQsa = V.get(estadoCorrente) + somatudo;
                guardador.put(a, calculaQsa);
...
*/
    ...
    public void policyIterationBelman(HashMap<Estado,Acao> politica, int z, int x) {
        for (Estado s : p.getEstados().values()) {//inicializar V
        ...
        boolean compara=true;
        do{
            policyEvaluationBelman(0.00000000000001, 1, 1, politica);
            compara =policyImrprovementBelman(politica);
        }while(compara==false);
   ...
   /*     Map<Integer, Estado> estados = this.p.getEstados();
        ...
        for (int i = x - 1; i >= 0; i--) {
            ...
            for (int y = 0; y < z; y++) {
                Estado s = p.getEstado(a[i][y]);
              // HashMap<Estado, Acao> t = politica.get(s);
                //int size = t.size();
                double valor = Double.POSITIVE_INFINITY;
                String nome = null;


                    Acao act = politica.get(s);
               // for (Iterator<Integer> it2 = estados.keySet().iterator(); it2.hasNext(); ) {//percorre todos os estados
                   // Integer k = it2.next();
                   // Estado estadoCorrente = estados.get(k);
                   // System.out.print(estadoCorrente.getName());
                   // politica.get(s).getName();
    ...
    public void iterterationValue1234231(Double minError, int x, int y) {
        Map<Integer, Estado> estados = this.p.getEstados();
        Q2 = new HashMap<>();
        V = new HashMap<>();
        double Q = 0;
            ...
            for (Iterator<Integer> it2 = estados.keySet().iterator(); it2.hasNext(); ) {//percorre todos os estados
                ...
                for (int i = 0; i < size; i++) {//itera por todas as acoes do estado s
                    ...
                    for (Iterator<Transicao> it = t.iterator(); it.hasNext(); ) //itera por todas transições da açao a
                    {
                       ...
                       // double X = calculaX(a.getCost(), p.getDiscount(), qcomparadorQlinha, Q, p.getK());
                        somatudo += prob * qcomparadorQlinha;
                    }
                    somatudo=a.getCost()+somatudo;
                    //somatudo = somatudo * p.getTamanhoPasso();
                    double calculaQsa = somatudo;
                    qtdeValueIteration2++;
                    // if (Qmax < calculaQsa) {
        ...
        String nome = " X= " + x + " Y=" + y + " k= " + p.getK() + " desconto= " + p.getDiscount() + " passo= " + p.getTamanhoPasso() + " belman.txt";
        String Diretorios = "desconto= " + p.getDiscount() + "/";
        imprimedireçãoQ3(x, y, nome, Diretorios);

    }

    public void printSIR(Arquivo file,int tamanhoMAxS,int n) {
        ...
        for (Integer chave : chaves) {
            ...
            if (e.isGoal()==true) {
                ...
                int s = e.getS();
                int i = e.getI();
                System.out.println("Meta"+"Estado: " + e.getName() + " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(0).getName() + " " + e.getAction(0).getQ() + "   " + e.getAction(1).getName() + " " + e.getAction(1).getQ() + "  " + e.getAction(2).getName() + " " + e.getAction(2).getQ() + "   " + e.getAction(3).getName() + " " + e.getAction(3).getQ() +  " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(4).getName() + " " + e.getAction(4).getQ()+ e.getName() + " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(5).getName() + " " + e.getAction(5).getQ()+ " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(6).getName() + " " + e.getAction(6).getQ()+e.getName() + " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(7).getName() + " " + e.getAction(7).getQ()+ e.getName() + " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(8).getName() + " " + e.getAction(8).getQ()+" acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getAction(9).getName() + " " + e.getAction(9).getQ());
                a[s][i] = "meta";
            }
            else {
                //  if (e.getAction(0)!= null&e.getAction(1)!= null&&e.getAction(2)!= null&&e.getAction(3)!= null)
...
*/
                int s = e.getS();
                int i = e.getI();
                a[s][i] = e.getAction(e.getBestAction()).getName();
                file.escreveArquivo("Estado: " + e.getName() + " acao: " + e.getAction(e.getBestAction()).getName() + " custo: " + e.getCost());
        ...
        for (int i = 0; i < tamanhoMAxS; i++) {
            ...
            for (int i2 = 0; i2 < tamanhoMAxS; i2++) {
                if (a[i2][i] == null) {
                    System.out.print("*");
                }

                else {
                    if (a[i2][i].equals("acao1")) {
                        System.out.print("0");
                    }
                    else if (a[i2][i].equals("acao2")) {
                        System.out.print("1");
                    }
                    else if (a[i2][i].equals("acao3")) {
                        System.out.print("2");
                    }
                    else if (a[i2][i].equals("acao4")) {
                        System.out.print("3");
                    }
                    else if (a[i2][i].equals("acao5")) {
                        System.out.print("4");
                    }
                    else if (a[i2][i].equals("acao6")) {
                        System.out.print("5");
                    }
                    else if (a[i2][i].equals("acao7")) {
                        System.out.print("6");
                    }
                    else if (a[i2][i].equals("acao8")) {
                        System.out.print("7");
                    }
                    else if (a[i2][i].equals("acao9")) {
                        System.out.print("8");
                    }
                    else if (a[i2][i].equals("acao10")) {
                        System.out.print("9");
                    }
                    else if (a[i2][i].equals("meta")) {
                        System.out.print("k");
                    }else
                    {
                        System.out.print("-");
