...
public class NewHeuristica3 extends Heuristica {
    double heuristic=0;
    HashMap<Estado, HashMap<Acao, Double>> Q;
    public NewHeuristica3(Map<Integer, Estado> e, double a,HashMap<Estado, HashMap<Acao, Double>> Q)
    {
        estadosFinais = e;
        heuristic=a;
        this.Q=Q;
    ...
    public double calcula(Estado e) {
        ...
        double Qmin=Double.NEGATIVE_INFINITY;
