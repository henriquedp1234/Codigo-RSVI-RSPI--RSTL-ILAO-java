 ...
 */
public class criaProblemaSIRvariasMeta {
    public Problem p;
    double beta;
    double lambda;
    double costvaccine;
    ...
    public criaProblemaSIRvariasMeta(int s, int i, int r, double beta, double lambda, double costvaccine, double costinf, Problem p, double exp) {
...
criaTodosEstados(s,i,r);
    ...
    void geraTodasAcoes2ComProbe2Binomiais2custoexp(int numeroDeAcoes,double exp) {
       ...
       // p.setInitialState("s=9.0 i=1.0 r=0.0");
        //p.setInitialState("s=18.0 i=2.0 r=0.0");
        p.setInitialState("s=45.0 i=5.0 r=0.0");
       //  p.setInitialState("s=36.0 i=4.0 r=0.0");
      // p.setInitialState("s=27.0 i=3.0 r=0.0");
      //  p.setInitialState("s=150.0 i=0.0 r=0.0");
     //   //p.setInitialState("s=50.0 i=0.0 r=0.0");
     //   p.setInitialState("s=90.0 i=10.0 r=0.0");
      //  p.setInitialState("s=20.0 i=0.0 r=0.0");
    ...
    double g=(-costinf*estadoAtual.getI())+(estadoAtual.getR()*costinf);*/
     ...
     //   double e= (-costvaccine*(a.getActionProbabilityproDominio()*estadoAtual.getS()))- (Math.pow(costinf, exp)); //dif2
      ...
      // double e= (-costvaccine*Math.pow((a.getActionProbabilityproDominio()*estadoAtual.getS()),exp))- (Math.pow(costinf, exp)); dif1
        ...
        //return e+f;
       // double e= (-costvaccine*((Math.pow(a.getActionProbabilityproDominio()*(estadoAtual.getS()*Factor), exp)))- (costinf* (estadoAtual.getI()*Factor)));
