 ...
 */
public class criaProblemaIgorpositivo2 {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorpositivo2(int Nx, int Ny, Double p, Problem prob) {
        // double p1 = p;
