 ...
 */
public class criaProblemaIgorpositivo3mudcost {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorpositivo3mudcost(int Nx, int Ny, double p, Problem prob,double costriver,double cost,double probMoveOutsideRiver) {
        // double p1 = p;
