 ...
 */
public class criaProblemaIgorpositivo33 {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorpositivo33(int Nx, int Ny, Double p, Problem prob) {
        // double p1 = p;
