 ...
 */
public class criaProblemaSIRsemmetv2 {
    public Problem p;
    double beta;
    double lambda;
    double costvaccine;
    ...
    public criaProblemaSIRsemmetv2(int s, int i, int r, double beta, double lambda, double costvaccine, double costinf, Problem p, double exp) {
    ...
    void geraTodasAcoes2ComProbe2Binomiais2custoexp(int numeroDeAcoes,double exp) {
        ...
        for ( Estado s : this.p.getEstados().values()) {
            for (int i = 1; i <= numeroDeAcoes; i++) {
                ...
                a.setCost(calculaCusto3(s, a,exp));
                        ...
                        for (int z1 = (int) qfloor; z1 <= (int) qceil; z1++) {
                            ...
                            if (ss+rr+ii==this.n )//estado gerado == tamanho
                            {
                             ...
                             //   a2.setCurrentState(s);
                                ...
                                if (sucessor.getI()==0)
                                {
int yyyyyyyyyyyyyyyyyyyyyyyyy=0;
                                }
                                else{
