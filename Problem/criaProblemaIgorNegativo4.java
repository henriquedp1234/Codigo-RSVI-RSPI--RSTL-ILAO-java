 ...
 */
public class criaProblemaIgorNegativo4 {//gera identico ao problema do texto mas custo negativo
    ...
    public criaProblemaIgorNegativo4(int Nx, int Ny, Double p, Problem prob) {
        // double p1 = p;
