...
public class LAOtrue2SIR {
    ...
    public LAOtrue2SIR(Problem p, double qnormal, double qmeta)//sem heuristica
    ...
    public LAOtrue2SIR(Problem p, double qnormal, double qmeta, int k)//2Lao
    ...
    public LAOtrue2SIR(Problem p, double qnormal, double qmeta, int x, int y)//heuristica determinizacao
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
    ...
    public LAOtrue2SIR(Problem p, double qnormal, double qmeta, int x, int y, int pranada)//heuristica iv
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
    ...
    public LAOtrue2SIR(Problem p, double qnormal, double qmeta, int x, int y, int pranada, int pranada2)//heuristica iv
    {
        count = 0;
        this.p = p;
        this.qnormal = qnormal;
    ...
    public void executaLaoPolitica(int dynammicAlgorithm) throws Exception {
        ...
        HashMap<Estado, Double> Vlinha = new HashMap<>();//map para guardar o Vanterior.
        for (Estado s : p.getEstados().values()) {
        ...
        while (fIntercepGlinha == false){
            ...
            if (Scandidato.iterator().hasNext()) {
                ...
                valueIterationRebuild(Qlinha,Vlinha, Glinha);
    ...
    public List<Estado> retornaTransicoes(Estado e, HashSet<Estado> I) {
        ...
        for (int j = 0; j < size2; j++) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (I.contains(compara) == false && compara!=e) {
...
*/
   ...
   /*     String nome = " X= " + x + " Y=" + y + " k= " + p.getK() + " desconto= " + p.getDiscount() + " passo= " + p.getTamanhoPasso() + " 2.txt";
    ...
    public void printSIR2(Arquivo file,int tamanhoMAxS,int n) {
