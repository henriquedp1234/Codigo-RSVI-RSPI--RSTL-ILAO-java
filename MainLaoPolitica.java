...
{	
	...
	//	arquivoEntrada = new Arquivo("river_3x3.net", Arquivo.LEITURA);
		...
		//	cenarioDenis c = new cenarioDenis(p);
			...
			p.setK(-0.9);
			//lao2 = new LAOtrue2(p,1,0,x,y,0,1);//iv
...
//			arquivoEntrada.fechaArquivo();
		...
		String nome=" X= "+x + " Y=" + y + " k= " + p.getK() + " desconto= " + p.getDiscount() + " passo= " + p.getTamanhoPasso() + " IV.txt";
		...
		lao2.printLAO(arquivoSaida,x,y);
		//lao2.printDenis(arquivoSaida,x,y);
